...
The system is simulated with a nonlinear load; we consider a diode rectifier bridge. The steady state output voltage and load current are shown in Fig.~\ref{fig:ss_vc} and
